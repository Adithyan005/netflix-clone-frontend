...
const Home = () => {
  ...
  return (
    <div className="md:relative relative">
      ...
      <div className="w-[90vw] md:absolute md:left-8  md:top-[62vh] absolute left-4 top-[70vh]">
        <div className="md:mt-[5rem] md:ms-2 md:mb-[1rem] mt-[3rem] ms-2 mb-[2rem] overflow-x-hidden">
