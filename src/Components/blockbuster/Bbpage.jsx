...
const Bbpage = () => {
  ...
  const trailerUrl = convertToEmbedUrl(moviedetails.trailerurl);
     ...
     <div className="text-white">
          ...
          <div className="flex justify-between gap-3 mt-3 px-3 md:flex-row md:justify-between md:items-center md:gap-10 md:mt-5 md:px-6">
            <div className="font-stylish ">
              <h1 className="text-lg font-semibold md:text-2xl">{moviedetails.name}</h1>
          ...
          <div className="flex flex-col gap-5 mt-5 px-5 md:flex-row md:justify-between md:items-center md:gap-4 md:mt-6 md:px-6">
            <img src={moviedetails.image} alt="Movie" className="w-[90vw] md:w-[35vw]" />
          ...
          <div className="font-stylish text-justify mt-7 px-3 md:px-6 md:w-[70vw] md:divide-y md:divide-stone-100">
            <p className="tracking-wide">{moviedetails.description}</p>
          </div>
          ...
          <div className="flex flex-col gap-5 mt-7 mb-6 px-3 text-lg md:flex-col md:gap-8 md:px-6 ">
            <div className="flex items-center gap-4 text-lg ">
              ...
              <p className="text-cyan-500">{moviedetails.director}</p>
            </div>
            <div className="flex items-center gap-5">
              <h1 className="font-semibold text-lg md:text-xl">Writers</h1>
              <p className="text-cyan-500">{moviedetails.writers}</p>
            </div>
            <div className="flex items-center gap-9">
              <h1 className="font-semibold text-lg md:text-xl">Stars</h1>
              <p className="text-cyan-500">{moviedetails.cast}</p>
            </div>
          </div>
        </div>
  )
